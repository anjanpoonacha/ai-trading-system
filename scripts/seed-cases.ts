...
const cases: Array<CaseInput & { folder: string; clip_file: string; video_id: string }> = [
  ...
  {
    folder: "014-KPRMILL-climax",
    symbol: "KPRMILL",
    label: "avoid",
    sub_label: "buying_climax",
    confidence: "strong",
    notes: "After rally from ₹480 to ₹750, massive volume spike (21.433M) at ₹750 = buying climax. Post-climax: volatile/choppy → Stage 3 distribution. Do NOT buy at climax.",
    timeframe: "weekly",
    market: "NSE",
    ...
    image_quality: "course_clip",
    needs_fresh_screenshot: 1,
    video_id: "s4V52_T4GvE",
    clip_file: "s4V52_T4GvE_1030.mp4",
  },
  {
